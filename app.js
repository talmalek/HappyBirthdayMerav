...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const HE_WISHES = [
        { category: "אהבה רומנטית", text: "מזל טוב לאשתי המדהימה מירב! כל יום איתך הוא מתנה, ואני כל כך מאושר לצעוד לצידך בחיים. אוהב אותך עד השמיים! ❤️" },
        ...
        { category: "מחמאה מהלב", text: "מירב, האלגנטיות שלך, הטוב שבלבך והעיניים המהפנטות שלך גורמים לי להתאהב בך מחדש כל יום! 🥰" },
        ...
        { category: "נשמת תאומה", text: "החיים איתך הם הרפתקה מתמשכת מלאה במתיקות. מזל טוב לאהבת חיי, מירב! 🌹" },
        ...
        { category: "אהבה רומנטית", text: "לא משנה כמה נרות יש על העוגה, האש של האהבה שלי אלייך בוקעת חזק יותר מאי פעם. מזל טוב מירב! 🔥❤️" },
    ...
    const DICTIONARY = {
        he: {
            ...
            wishModalTitle: "מזל טוב, מירב!",
            dismissHint: "✨ לחצי מחוץ לכרטיס כדי לסגור ✨",
            birthdayArrived: "מזל טוב מירב! 🎉",
            langLabel: "HE"
        },
        en: {
